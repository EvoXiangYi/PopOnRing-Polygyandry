function []= DispersalSimulation_Polygyandry(InTimeSteps, InNumGrid, InPopSize, InNumHabitats, InpSpatial, InpTemporal, InfitnessIOS, InMeanDispersalTrait_init, InSigmaDispersalTrait_init, InSigmaTraitCoordinates, InSigmaDispersal, InDispersalDeathRate, InNumRepeats)
	...
	for t=1:timeSteps
		...
		%%%%%%%%%%%%%%%%%%%%% finding parents for babies %%%%%%%%%%%%%%%%%%%%%
		PotentialParents=[];
		% row 1 -> indices of wives
		% row 2 -> fitness of wives
		
		for i=1:totalEffectiveHabitats
			newParents=pairParents(femalesOnHabitatsCell{i}, femalesFitnessOnHabitatsCell{i}, malesOnHabitatsCell{i}, malesFitnessOnHabitatsCell{i});
		...
		%%%%%%%%%%%%%%%%%%%%%%%% making babies %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		babyMatrix = makeBabies(population, parentMatrix(1,:), parentMatrix(2,:));
	...
	csvwrite([strcat("FitnessOrder1-Polygyandry-InitDispProb-", num2str(init_Prob_dispersal), "-numGrid-", num2str(numGrid), "-numHabitats-", num2str(numHabitats),"-Rep-", num2str(numRepeats), ".csv")], SummaryData);
end